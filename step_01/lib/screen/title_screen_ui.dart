...
import 'package:next_gen_ui/common/shader_painter.dart';
...
class _DifficultyBtns extends StatelessWidget {
  const _DifficultyBtns({super.key, required this.difficulty, required this.onDifficultyPressed, required this.onDifficultyFocused});
...
class _DifficultyBtn extends StatelessWidget {
  const _DifficultyBtn({super.key, required this.label, required this.selected, required this.onPressed, required this.onHover});
